        ...
        <div className="detalhe-info">
          ...
          <div className="sku-actions">
            <a
              ...
              href={`https://lista.mercadolivre.com.br/${encodeURIComponent(`${produto.nome} ${produto.marca} ${produto.descricao}`)}`}
              target="_blank"
            ...
            <a
              className="btn-marketplace"
              href={`https://shopee.com.br/search?keyword=${encodeURIComponent(`${produto.nome} ${produto.marca} ${produto.descricao}`)}`}
              target="_blank"
              rel="noopener noreferrer"
            >
